...
-- Trigger para atualizar estoque após inserir item de compra
DELIMITER $$
CREATE TRIGGER IF NOT EXISTS update_stock_after_purchase_insert
AFTER INSERT ON product_purchase_items
FOR EACH ROW
BEGIN
